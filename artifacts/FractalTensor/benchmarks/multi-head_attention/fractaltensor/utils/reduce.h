...
__device__ inline void thread_reduce_(
    cute::Tensor<Engine0, Layout0> const& tensor,
...
template <typename Engine0, typename Layout0, typename Engine1,
          typename Layout1, typename Operator>
__device__ inline void quad_allreduce_(cute::Tensor<Engine0, Layout0>& dst,
...
template <typename Engine0, typename Layout0, typename Engine1,
          typename Layout1, typename Operator>
__device__ inline void eight_allreduce_(cute::Tensor<Engine0, Layout0>& dst,
                                        cute::Tensor<Engine1, Layout1>& src,
                                        Operator& op) {
    using namespace cute;
    CUTE_STATIC_ASSERT_V(size(dst) == size(src));
...
template <int Rthreads, typename Engine0, typename Layout0, typename Engine1,
          typename Layout1, typename Operator>
__device__ inline void allreduce_(cute::Tensor<Engine0, Layout0>& dst,
                                  cute::Tensor<Engine1, Layout1>& src,
                                  Operator& op) {
    using namespace cute;
    CUTE_STATIC_ASSERT_V(size(dst) == size(src));
...
template <int Rthreads, bool zero_init = true, typename Engine0,
          ...
          typename Operator>
__device__ inline void reduce_(cute::Tensor<Engine0, Layout0> const& tensor,
...
template <int Rthreads, bool zero_init = true, typename Engine0,
          typename Layout0, typename Engine1, typename Layout1>
__device__ inline void reduce_max(cute::Tensor<Engine0, Layout0> const& tensor,
...
template <int Rthreads, typename Engine0, typename Layout0, typename Engine1,
          typename Layout1>
__device__ inline void reduce_sum(cute::Tensor<Engine0, Layout0> const& tensor,
...
template <int Rthreads, typename Engine0, typename Layout0, typename Engine1,
          typename Layout1>
__device__ inline void reduce_sumabs(
    cute::Tensor<Engine0, Layout0> const& tensor,
    cute::Tensor<Engine1, Layout1>& sum) {
